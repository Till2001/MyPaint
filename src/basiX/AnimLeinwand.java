...
/**
 * überarbeitet Mai 2011 Eine AnimLeinwand beschreibt einen rechteckigen Bereich.
 ...
 * verwenden zu können, müssen ein Fenster oder ein Container-Objekt vorhanden
 ...
 * Leinwandobjkekte können selbst als Container für andere
 * Leinwandobejkte genommen werden. So kann man eine Zeichenfläche in
 * unabhängige Bereiche aufteilen. 
 * Zur Ereignisbearbeitung: Ob die Leinwand  durch Überdecken mit einem Fenster, Größenveränderung oder ähnliches vom
 * System neu gezeichnet wurde, kann über die Anfrage wurdeNeuGezeichnet
 ...
 * Verfügung, so dass spezialisierte Leinwandklassen gebildet werden können.
 */
...
public class AnimLeinwand extends Komponente implements Serializable,
	...
	/**
	 * Öffnet Dateidialog zum Öffnen einer png-, jpg-, gif oder bmp-Bilddatei.
	 * Diese wird eingelesen und und auf der Zeichenfläche angezeigt
	 */
	...
	/**
	 * Speichert Zeichenfläche über einen Dialog. Als Dateiformat kommen gif,
